import { User, ResultadoProva, Event } from '@/lib/types';
...
import { Plus, Pencil, Trash, Trophy } from '@phosphor-icons/react';
...
interface ResultadosTreinosTabProps {
  user: User;
  isAdmin: boolean;
}

export function ResultadosTreinosTab({ user, isAdmin }: ResultadosTreinosTabProps) {
    ...
    <div className="space-y-2">
      ...
      {atletaResultados.length === 0 ? (
        <div className="p-8 border rounded-lg text-center">
          <Trophy className="mx-auto text-muted-foreground mb-2" size={32} weight="thin" />
